(module colour-test mzscheme
  
  (require
   (planet "test.ss" ("schematics" "schemeunit.plt" 2))
   (planet "random.ss" ("cce" "fasttest.plt" 1))
   (planet "schemeunit.ss" ("cce" "fasttest.plt" 1))
   (file "colour.ss"))
  
  (provide colour-tests)
  
  (define colour-tests
    (test-suite
     "All tests for colour"
